...
# psg_exp_name="flat_hierarchical_passage-mean"
...
#         --ablation_config '{"inter_block_encoder":false, "doc_token":false, "segments": false, "start_separator": false, "text_separator": true, "end_separator": false, "cls_position": "relative"}'

task="msmarco-doc"

exp_name="flat_hierarchical_doc-mean"
...
# psg_exp_name="flat_hierarchical_passage-attention"
# psg_model_path=$STORAGE_DIR'/models/longtriever_og/'$psg_exp_name
# echo $psg_model_path
# if [[ ! -d $psg_model_path ]]; then
#   mkdir -p $psg_model_path
...
exp_name="flat_hierarchical_doc-attention"
model_path=$STORAGE_DIR'/models/longtriever_og/'$exp_name
echo $model_path
if [[ ! -d $model_path ]]; then
  mkdir -p $model_path
