...
#         --model_name_or_path $STORAGE_DIR/models/longtriever_og/rocket_passage \
...
#         --max_corpus_sent_num 8 \
#         --model_type longtriever\
#         --model_name_or_path $STORAGE_DIR/models/longtriever_og/hier_rocket_passage \
#         --output_dir $model_path \
#         --do_train True \
#         --num_train_epochs 3 \
#         --save_strategy epoch \
...
torchrun --nproc_per_node=4 src/longtriever/run.py \
        ...
        --max_corpus_length 512 \
        --model_type bert\
        --model_name_or_path $STORAGE_DIR/models/longtriever_og/rocket_bert_psg \
        --output_dir $model_path \
        --do_train True \
        --num_train_epochs 3 \
        --save_strategy epoch \
