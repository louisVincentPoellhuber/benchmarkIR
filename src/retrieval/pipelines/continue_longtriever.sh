...
model_config='{"q_model": "STORAGE_DIR/models/longtriever/pretrained/bert-base-uncased",
        ...
        "max_num_blocks": 8, 
        "checkpoint": "STORAGE_DIR/models/longtriever/longtriever_test/checkpoints/checkpoint-2"
        }'
...
accelerate launch src/retrieval/train_longtriever.py --config_dict "$config"
