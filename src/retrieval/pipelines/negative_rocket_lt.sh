...
exp_name="negative_rocket_lt-passage"
batch_size=32
...
exp_name="negative_rocket_lt-doc"
batch_size=4
lr=3e-5
export EXP_NAME=$exp_name
...
echo Preprocessing data. 
python src/retrieval/preprocessing/preprocess_msmarco-passage.py 
model_config='{"q_model": "STORAGE_DIR/models/longtriever/negative_rocket_lt-passage/q_model",
        "doc_model": "STORAGE_DIR/models/longtriever/negative_rocket_lt-passage/doc_model",
        "shared_encoder": false,
        "normalize": false, 
        "attn_implementation": "eager", 
        "query_prompt": "",
